...
The Windows execution checkout and committed Git blobs differ in line endings for some files. The manifest records both byte forms and confirms that CRLF normalization reproduces every committed blob; parsed JSON is also identical. The **committed raw gate SHA256** for official preflight is `254301db081093433411b9b90d7d44eaa14287bd13eb8cda7273f481d3187166` (7,199 bytes). The Windows checkout raw file is `f30c181f9531615fb3cec5b5cc3144a8ff4ac6a5a54a692d8826142370d65f39` (7,402 bytes).
