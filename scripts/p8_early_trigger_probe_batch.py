"""Fresh official Thor resets for development-only early looming arm probes."""
...
def main():
    ...
    if a.development_probe:
        result = "DEVELOPMENT_PROBE" if (batch_error is None and len(rows) == len(seeds)
    ...
    report = {
        "schema_version": "p8-v2-early-trigger-development-batch-v1",
