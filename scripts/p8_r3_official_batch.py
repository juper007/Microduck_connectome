"""Three independent official Thor moving-body P8-R3 recertification resets."""
...
def main():
    ...
    try:
        if len(planned) != 3 or [r["seed"] for r in planned] != protocol["scenario_seeds"]:
            raise ValueError("frozen three-reset seed matrix mismatch")
        for index, planned_row in enumerate(planned):
            ...
            try:
                ...
                command = [
                    sys.executable, str(root / "scripts/p8_r3_official_trial.py"),
    ...
    report = {
        "schema_version": "p8-r3-official-batch-v1",
    ...
    manifest_path.write_text(json.dumps({
        "schema_version": "p8-r3-official-raw-manifest-v1", "source_head": head,
