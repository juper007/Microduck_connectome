"""P8-R3 V2.1 separate 10/20/25 Hz sampling factor; no robotd/final seeds.
                ...
                for motion in MOTIONS:
                    for seed, arm_elapsed_s in zip(SEEDS, ARM_ELAPSED_S):
                        cases.append(run_case(graph, scenario, visual_hz=visual_hz,
                                              ...
                                              arm_elapsed_s=arm_elapsed_s, motion=motion))
    report = {
        "schema_version": "p8-r3-v21-sampling-development-v1",
        "scope": "separate 10/20/25 Hz fractional RGB sampling factor and graph-v2; no moving body or robotd",
