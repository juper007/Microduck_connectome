"""Fresh official Thor resets for P8-R1 stop-persistence development trials."""
...
def main():
    ...
    if protocol_path.read_bytes() != subprocess.check_output([
        "git", "-C", str(root), "show", "HEAD:config/p8_r1_dev_v3.json"]):
    ...
    try:
        ...
        for index, seed in enumerate(seeds):
            ...
            try:
                ...
                command = [
                    sys.executable, str(root / "scripts/p8_r1_stop_persistence_trial.py"),
    ...
    report = {
        "schema_version": "p8-r1-stop-persistence-development-batch-v3",
    ...
    manifest_path.write_text(json.dumps({
        "schema_version": "p8-r1-raw-manifest-v3", "source_head": head,
