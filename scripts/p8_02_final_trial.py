...
def run(args):
    ...
    seed = row["seed"]
    trial_id = (f"p8-02-final-{row['run_id']}" if protocol["schema_version"] ==
                "p8-02-final-approach-v1" else f"p8-r3-dev-{row['run_id']}")
    ...
    summary = {
        "schema_version": ("p8-02-final-approach-trial-v1" if protocol["schema_version"] ==
                           "p8-02-final-approach-v1" else "p8-r3-official-trial-v1"),
        "result": result,
